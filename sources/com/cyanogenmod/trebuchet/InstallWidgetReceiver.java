...
public class InstallWidgetReceiver {
    ...
    public static class WidgetListAdapter implements ListAdapter, OnClickListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            WidgetMimeTypeHandlerData data = (WidgetMimeTypeHandlerData) this.mActivities.get(position);
        ...
        public void onClick(DialogInterface dialog, int which) {
            this.mLauncher.addAppWidgetFromDrop(new PendingAddWidgetInfo(((WidgetMimeTypeHandlerData) this.mActivities.get(which)).widgetInfo, this.mMimeType, this.mClipData), -100, this.mTargetLayoutScreen, null, this.mTargetLayoutPos);
        }
    }
