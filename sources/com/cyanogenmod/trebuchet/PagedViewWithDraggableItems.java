...
public abstract class PagedViewWithDraggableItems extends PagedView implements OnLongClickListener, OnTouchListener {
    ...
    public boolean onLongClick(View v) {
        if (v.isInTouchMode() && this.mNextPage == -1 && this.mLauncher.isAllAppsCustomizeOpen() && !this.mLauncher.getWorkspace().isSwitchingState()) {
